...
return e.Mediator=t(),e.Mediator()}):e.Mediator=t()})
(this,function(){
...
n.prototype={addSubscriber:function(e,n,r){
	var i=new t(e,n,r);
				...
				getSubscriber:function(e){
					...
					setPriority:function(e,t){
						...
						for(r=0,u=this._subscribers.length;r<u;r++){
							if(this._subscribers[r].id===e||this._subscribers[r].fn===e)
								break;n++
								}
...
hasChannel:function(e){return this._channels.hasOwnProperty(e)
	},
	returnChannel:function(e){return this._channels[e]
	},
	removeSubscriber:function(e){
		var t=this._subscribers.length-1;
		if(!e){this._subscribers=[];
		return}
		for(t;t>=0;t--)
			if(this._subscribers[t].fn===e||this._subscribers[t].id===e)
				this._subscribers[t].channel=null,this._subscribers.splice(t,1)
				},
				publish:function(e){
					var t=0,n=this._subscribers.length,r=!1,i,s,o,u;
					for(t,n;t<n;t++)
						this.stopped||(i=this._subscribers[t],i.options!==undefined&&typeof i.options.predicate=="function"?i.options.predicate.apply(i.context,e)&&(i.fn.apply(i.context,e),r=!0):(o=this._subscribers.length,i.fn.apply(i.context,e),u=this._subscribers.length,n=u,u===o-1&&t--,r=!0)
				),
...
r.prototype={getChannel:function(e){
...
subscribe:function(e,t,n,r){
	...
	once:function(e,t,n,r){
		return n=n||{},n.calls=1,this.subscribe(e,t,n,r)},getSubscriber:function(e,t){
...
r.push(n.replace(t||(t=/\{([\d\w\.]+)\}/g),
	...
	var n;$.padWithZero=function(e){
		return e.replace(n||(n=/(^|\D)(\d)(?=$|\D)/g),"$10$2")
						},
						r.prototype={getMonthFirstDate:function(){
...
var n=this.julianDay-s.JD2000,o=i.getTerms(n),u=r.getNewMoons(o);t.getFullYear()=="1957"&&(u[2].days=30,u[3].days=29,u[4].days=30);
for(var a=Math.round(n-u[0].JD),f=0,l;f<u.length;f++){l=u[f];
if(a<l.days){
...
var c=u[u.zyIndex].JD;c-=n<c?365:0,c+=5810,this.sYear=Math.floor(c/365.2422+.5),this.hYear=this.sYear+1984+2698;
var c=o.hash[n];
this.term=c?c.name:"";
var c=this.lYear+6e3;
this.animal=e.chineseZodiac[c%12],this.db=e,this.gzYear=e.heavenlyStems[c%10]+e.earthlyBranches[c%12];
var c=Math.floor((n-o[0].JD)/30.43685);c<12&&n>=o[2*c+1].JD&&c++,c+=Math.floor((o[12].JD+390)/365.2422)*12+9e5,this.gzMonth=e.heavenlyStems[c%10]+e.earthlyBranches[c%12];
var c=n-6+9e6;
...
function y(e,t,n,r){
	n/=10;var i,s,a=0,l=1,c,h=u[e],p,d,v,m,g=t*6+1,y=h[g+1]-h[g];
	for(i=0;i<6;i++,l*=n){p=h[g+i],d=h[g+1+i],m=d-p;
	if(!m)continue;
	r<0?v=d:(v=Math.floor(3*r*m/y+.5)+p,i&&(v+=3),v>d&&(v=d));
	for(s=p,c=0;s<v;s+=3)c+=h[s]*Math.cos(h[s+1]+n*h[s+2]);a+=c*l}a/=h[0];
	if(e==0){
		var b=n*n,w=b*n;t==0&&(a+=(-0.0728-2.7702*n-1.1019*b-.0996*w)/f),t==1&&(a+=(0+4e-4*n+4e-4*b-.0026*w)/f),t==2&&(a+=(-0.002+.0044*n+.0213*b-.025*w)/1e6)
		}else{
			var E=o[(e-1)*3+t];t==0&&(a+=-3*n/f),t==2?a+=E/1e6:a+=E/f}
	return a}
function b(e,t,n){
	var r=a[e],i,s,o,u,l=0,c=1,h,p=t*t,d=p*t,v=d*t,m=v*t,g=t-10;e==0&&(l+=(3.81034409+8399.684730072*t-3319e-8*p+3.11e-8*d-2.033e-10*v)*f,l+=5028.792262*t+1.1124406*p+7699e-8*d-23479e-9*v-1.78e-8*m,g>0&&(l+=-0.866+1.43*g+.054*g*g)),p/=1e4,d/=1e8,v/=1e8,n*=6,n<0&&(n=r[0].length);
	for(i=0;i<r.length;i++,c*=t){
		o=r[i],u=Math.floor(n*o.length/r[0].length+.5),i&&(u+=6),u>=o.length&&(u=o.length);
		for(s=0,h=0;s<u;s+=6)h+=o[s]*Math.cos(o[s+1]+t*o[s+2]+p*o[s+3]+d*o[s+4]+v*o[s+5]);l+=h*c
		}
	return e!=2&&(l/=f),l}
function E(e){
	var t="0000000000",n=t+t,r={J:"00",I:"000",H:"0000",G:"00000",t:"01",s:"001",r:"0001",q:"00001",p:"000001",o:"0000001",n:"00000001",m:"000000001",l:"0000000001",k:"03",j:"0303",i:"003",h:"003003",g:"0003",f:"00003",e:"000003",d:"0000003",c:"00000003",b:"000000003",a:"0000000003",A:n+n+n,B:n+n+t,C:n+n,D:n+t,E:n,F:t
		};
...
var e={digitCN:["\u96f6","\u4e00","\u4e8c","\u4e09","\u56db","\u4e94","\u516d","\u4e03","\u516b","\u4e5d","\u5341"],heavenlyStems:["\u7532","\u4e59","\u4e19","\u4e01","\u620a","\u5df1","\u5e9a","\u8f9b","\u58ec","\u7678"],earthlyBranches:["\u5b50","\u4e11","\u5bc5","\u536f","\u8fb0","\u5df3","\u5348","\u672a","\u7533","\u9149","\u620c","\u4ea5"],chineseZodiac:["\u9f20","\u725b","\u864e","\u5154","\u9f99","\u86c7","\u9a6c","\u7f8a","\u7334","\u9e21","\u72d7","\u732a"],term:["\u51ac\u81f3","\u5c0f\u5bd2","\u5927\u5bd2","\u7acb\u6625","\u96e8\u6c34","\u60ca\u86f0","\u6625\u5206","\u6e05\u660e","\u8c37\u96e8","\u7acb\u590f","\u5c0f\u6ee1","\u8292\u79cd","\u590f\u81f3","\u5c0f\u6691","\u5927\u6691","\u7acb\u79cb","\u5904\u6691","\u767d\u9732","\u79cb\u5206","\u5bd2\u9732","\u971c\u964d","\u7acb\u51ac","\u5c0f\u96ea","\u5927\u96ea"],monthCn:["\u5341\u4e00","\u5341\u4e8c","\u6b63","\u4e8c","\u4e09","\u56db","\u4e94","\u516d","\u4e03","\u516b","\u4e5d","\u5341"],dateCn:["\u521d\u4e00","\u521d\u4e8c","\u521d\u4e09","\u521d\u56db","\u521d\u4e94","\u521d\u516d","\u521d\u4e03","\u521d\u516b","\u521d\u4e5d","\u521d\u5341","\u5341\u4e00","\u5341\u4e8c","\u5341\u4e09","\u5341\u56db","\u5341\u4e94","\u5341\u516d","\u5341\u4e03","\u5341\u516b","\u5341\u4e5d","\u4e8c\u5341","\u5eff\u4e00","\u5eff\u4e8c","\u5eff\u4e09","\u5eff\u56db","\u5eff\u4e94","\u5eff\u516d","\u5eff\u4e03","\u5eff\u516b","\u5eff\u4e5d","\u4e09\u5341","\u5345\u4e00"]
},
r={correction:E(""),
calcForLow:function(e){
var t=7771.37714500204,n=(e+1.08472)/t,r;
return n-=(-0.0000331*n*n+.10976*Math.cos(.785+8328.6914*n)+.02224*Math.cos(.187+7214.0629*n)-.03342*Math.cos(4.669+628.3076*n))/t+(32*(n+1.8)*(n+1.8)-20)/86400/36525,n*36525+8/24},calcForHigh:function(e){
var t=w.MS_aLon_t2(e)*36525;t=t-v(t)+8/24;
var n=(t+.5)%1*86400;
...
cache:{},getNewMoons:function(t){
	...
	if(r.cache[i])s=r.cache[i];else{
		...
		if(s[13].JD<=t[24].JD){
			for(o=1;s[o+1].JD>t[2*o].JD&&o<13;o++);s[o].isLeap=!0;
			for(;o<14;o++)s[o].index--}
		for(o=0;o<14;o++)s[o].name=(s[o].isLeap?"\u95f0":"")+e.monthCn[s[o].index%12],s[o].nextName=(s[o+1].isLeap?"\u95f0":"")+e.monthCn[s[o+1].index%12],s[o].index==2&&(s.zyIndex=o);r.cache[i]=s
}
return s},
calc:function(e){
e+=s.JD2000;
...
if(e>=i&&e<o)
	return t=Math.floor(
			this.calcForLow(Math.floor((e+r-2451551)/29.5306)*Math.PI*2)+.5),n=this.correction.substr(Math.floor((e-i)/29.5306),1)-0,t+(n?n-2:n)
			}},
			i={correction:E(""),
calcForLow:function(e){
...
return i.calc(t)>e&&(t-=365.2422),t},cache:{},
getTerms:function(t){
	var n=i.getNearestWinter(t),r=[];
	if(i.cache[n])r=i.cache[n];
	else{
		r.hash={};
		for(var s=0,o;s<25;s++)o={JD:i.calc(n+15.2184*s),name:e.term[s%24]},r.push(o),r.hash[o.JD]=o;i.cache[n]=r
		}
	return r},
	calcForHigh:function(e){
		var t=w.S_aLon_t2(e)*36525;t=t-v(t)+8/24;
		var n=(t+.5)%1*86400;
		...
		calc:function(e){
			...
			if(e>=o&&e<u)
				return n=Math.floor(this.calcForLow(Math.floor((e+i-2451259)/365.2422*24)*Math.PI/12)+.5),
				r=this.correction.substr(Math.floor((e-o)/365.2422*24),1)-0,n+(r?r-2:r)}
		},
s={JD2000:2451545,
fromDate:function(e){
...
return l.sort(function(e,t){
	return t.type.charCodeAt(0)-e.type.charCodeAt(0)})}})(jQuery);
(function(){
...
l=function(e,t){
	var n=e.substr(0,4),r=e.substr(4,2),i=e.substr(6,2),
	s=new Date([n,r,i].join("/"));t!=0&&(s=t<0?new Date(+s-864e5):new Date(+s+864e5));
var u=o(s.getMonth()+1),a=o(s.getDate());
return[s.getFullYear(),u,a].join("/")};
for(var c=0;c<r.length;++c){
var h=r[c];lineInfo=h.split("||");
if(/^-\d{8}$/.test(lineInfo[0])){i.push({date:l(lineInfo[0].substr(1,8),-1),delta:lineInfo[1],cmd:"<"});
continue}
if(/^\d{8}$/.test(lineInfo[0])){i.push({date:l(lineInfo[0],0),delta:lineInfo[1],cmd:"="});
continue}
if(/^\+\d{8}$/.test(lineInfo[0])){i.push({date:l(lineInfo[0].substr(1,8),1),delta:lineInfo[1],cmd:">"});
continue}
if(/^c\d{8}-\d{8}$/.test(lineInfo[0])){
var p=lineInfo[0].replace("c","").split("-");s.min=l(p[0],0),s.max=l(p[1],0),s.color=lineInfo[1]}}e.Huochepiao={getHuochepiaoDay:function(e,t,n){
var r,u={},a=o(t),f=o(n),l=[e,a,f].join("/"),c;
for(var h=0;h<i.length;++h){r=i[h];
if(r.cmd=="<"&&l<=r.date||r.cmd=="="&&l==r.date||r.cmd==">"&&l>=r.date){c=+(new Date([e,t,n].join("/")))+(r.delta-1)*864e5,u.piaodate=new Date(c);
break}}
...
return $.format(f,{l:u})}}})();
(function(){$.widget("rili.fakeSelect",{options:{data:[],onchange:$.noop,value:"",circle:!1},
_create:function(){
var e=this,
t=$(this.element),
n=this.options;
...
this.cont.click(function(){
	...
	if(e.list.is(":visible")){
		...
		this.opts.mouseenter(function(){
			e.opts.removeClass("mh-on"),$(this).addClass("mh-on")}).click(function(t){
				e.list.hide();
				var r=$(this).addClass("mh-on"),i=r.attr("val"),
				s=r.text(),
				o=e.header.attr("val");
	...
	!i.size()&&$(this).siblings(".mh-control").find(".mh-field").hasClass("mh-month")&&("prev"==n.attr("action")?(i=$(e.opts[e.opts.length-1]),
					$(".mh-control .mh-year").parent(".mh-control").siblings(".mh-prev").triggerHandler("click")):(i=$(e.opts[0]),
					$(".mh-control .mh-year").parent(".mh-control").siblings(".mh-next").triggerHandler("click"))),
...
this.cont.find(".mh-holiday").length>0&&(r=e.opts.filter('[is_sel="true"]'),
		r.length&&e.header.html(r.text()).attr("val",r.attr("val"))),$("body").click(function(t){
	e.cont.find(t.target).size()||e.list.hide()})},hasValue:function(e){
...
(function(){$.widget("rili.speCalendar",{options:{},_create:function(){
	var e=this.element;e.delegate("li.mh-spe-item","mouseenter",function(){
		var e=$(this),t=e.find(".mh-spe-cover");t.show()}),e.delegate("li.mh-spe-item","mouseleave",function(){
			var e=$(this),t=e.find(".mh-spe-cover");t.hide()})},getTpl:function(e){
...
(function(){
	var e=window.OB.RiLi,t=e.msg_config,n=e.Huochepiao,r=e.mediator,i=e.lunar,s=e.Lunar,o=e.rootSelector||"",u=$.trim($(o+"#mh-date-y").html()),a=e.dateFestival,f=[],l,c,l,c;$.route=function(e,t){e=e||{};
...
$.each(e,function(e,r){n.push(t.replace(c||(c=/\{([\d\w\.]+)\}/g),function(t,n,i){
return i=n==="INDEX"?e:n.indexOf(".")<0?r[n]:$.route(r,n),i===undefined?t:$.isFunction(i)?i.call(r,n):i}))}),
n.join("")};var h;$.padWithZero=function(e){return e.replace(h||(h=/(^|\D)(\d)(?=$|\D)/g),"$10$2")},
$.each(a,function(e,t){
	var n=t.split("||");n[0]=="20140201"&&(n[0]="20140131"),f.push(n[0])}
),
$.widget("rili.webCalendar",{options:{onselect:$.noop},_create:function(){
var e=this,t=$(this.element);this.panel=t.find("ol.mh-dates-bd"),
...
var i=function(){
	var n=new Date;
	if(e.today){
		var r=new Date(e.today.getTime()+(n.getTime()-t.now.getTime()));t.timeContainer.html($.padWithZero($.format("{getHours}:{getMinutes}:{getSeconds}",r)))}};
clearInterval(this.handler),i(),this.handler=setInterval(function(){i()},1e3)},
initTime:function(n){
	var s=this,o=n?n:new Date,u=o.getFullYear(),a=o.getMonth()+1;
	this.now=new Date,this.today=e.today,
	this.initCalendar(u,a),
	this.options.onselect.call(s,o,i(o)),
	this._showCurrentTime(),r.publish(t.type.ctc,{data:o})},
	initCalendar:function(s,o,a){
		var l=this,c=$(this.element),
		h=this.options,
		p=new Date(s,o-1,a||1),
		d=new window.OB.RiLi.Calendar(p),v=d.getCalendarFirstDate(),
		m=this.today;
		this.year=p.getFullYear(),
		this.month=p.getMonth()+1,e.action=="goupiao"&&$(".mh-dates").addClass("mh-goupiao-dates");
var g={},y={},b={},w=e.dateRest;
$.each(w,function(e,t){g[t]="mh-rest"});

var E=e.dateWork;$.each(E,function(e,t){y[t]="mh-work"});

var S=new Date(v),x=$.map(new Array(42),function(s,a){
	var c=S.getFullYear(),h=S.getMonth(),p=S.getDate(),d=S.getDay(),v=i(S),w=[],E=("0"+(h+1)).slice(-2)+("0"+p).slice(-2),x=c+E+"";$.inArray(x,f)!=-1&&w.push("mh-fes"),h!=o-1&&w.push("mh-cross-month"),(a+1)%7==0&&w.push("mh-last"),p==m.getDate()&&h==m.getMonth()&&c==m.getFullYear()&&w.push("mh-today"),(d==0||d==6)&&w.push("mh-weekend");
var T=v.festival();v.term?w.push("mh-solar-style"):T.length&&w.push("mh-"+T[0].type+"solar-style"),c==u&&(g[E]&&w.push(g[E],"mh-vacation"),y[E]&&w.push(y[E]));
if(b[u+E]){
	r.publish(t.type.hgt,{data:b[u+E]});
	var N=t.returnValue
	}else 
		var N=l.tmplDate;S.setDate(S.getDate()+1),e.action=="goupiao"?goupiao=n.getHuochepiaoDayHtml(c,h+1,p):goupiao="";
var C,k;
return C=T[0]&&T[0].desc.length<9&&T[0].desc||v.term||v.dateIndex==0&&v.lMonth+"\u6708"+(v.isBigMonth?"\u5927":"\u5c0f")||v.lDate,C.length>4?$.format(N,{monthClass:w.join(" "),solar:p,lunar:C,date:[c,h+1,p].join("/"),goupiao:goupiao,lunarTitle:"title='"+C+"'"}):$.format(N,{monthClass:w.join(" "),solar:p,lunar:C,date:[c,h+1,p].join("/"),goupiao:goupiao,lunarTitle:""})});
this.panel.html(x)},handleClick:function(){
	var n=this,s=$(this.element),o=this.options;$(n.panel).delegate("li","click",function(){
...
r.publish(t.type.fhv,{data:f,from:n.dltYear}),c=t.returnValue,l==n.month&&f==n.year||!c?(o.onselect.call(n,a,i(a)),r.publish(t.type.ctc,{data:a}),
		typeof e.CallBack.holiday=="function"&&e.CallBack.holiday($.trim(n.panel.find('li[date="'+u+'"]').find(".mh-lunar").html()),n.year)):(r.publish(t.type.fsv,{data:f,from:n.dltYear}),
r.publish(t.type.fsv,{data:l,from:n.dltMonth}),r.publish(t.type.ftc,{data:{},from:n.dltMonth}),n.panel.find('li[date="'+u+'"]').click())})},
initDatePicker:function(){
	var n=this,i=$(this.element),s=this.options,o=function(e){
		var i,s;this.name=="year"?(i=e,r.publish(t.type.fgv,{data:{},from:n.dltMonth}),s=t.returnValue,e+=("0"+s).slice(-2)):(r.publish(t.type.fgv,{data:{},from:n.dltYear}),i=t.returnValue,s=e,e=i+("0"+s).slice(-2)),n.initCalendar(i,s),r.publish(t.type.fsv,{data:e,from:n.dltFestival})},
f=function(i){
	var s=i.slice(0,4)-0,o=i.slice(4,6)-0,u=i.slice(-2)-0;n.initCalendar(s,o,u);
	var f=a,l=[],c=s<10?"0"+s+"":s+"",h=o<10?"0"+o+"":o+"",p=u<10?"0"+u+"":u+"",d="";r.publish(t.type.fsv,{data:s,from:n.dltYear}),r.publish(t.type.fsv,{data:o,from:n.dltMonth});
for(var v=0;v<f.length;++v){l=$.trim(f[v]).split("||");
if(l[0].slice(0,8)==c+h+p){d=s+"/"+o+"/"+(l[0].slice(-2)-0)+"",d!="2014/2/1"?$("li[date='"+d+"']").click():typeof e.CallBack.holiday=="function"&&e.CallBack.holiday("\u6625\u8282",s);
break}}};
this.dltYear=i.find("div.mh-year-bar"),
this.dltMonth=i.find("div.mh-mouth-bar"),this.dltFestival=i.find("div.mh-holiday-bar");
var l=[];l.push({value:"",text:u+"\u5e74\u5047\u65e5\u5b89\u6392"});
var c=e.needDay||e.today,h=c.getMonth()+1,p=c.getDate();
h=h>9?h:"0"+h+"",
		$.each(a,function(e,t){//console.log(t);
var n={},r=t.split("||"),i=r[0].substr(0,8),s=r[1];n.value=i,n.text=s,i.substr(0,8)==c.getFullYear()+h+p?n.is_sel=!0:n.is_sel=!1,l.push(n)}),setTimeout(function(){
var i=e.needDay||e.today;r.publish(t.type.fin,{data:{name:"year",value:i.getFullYear(),onchange:o,data:$.map(new Array(200),function(e,t){
var n=1901+t;
return{
	value:n,text:n+"\u5e74"}})},from:n.dltYear})},200),setTimeout(function(){
r.publish(t.type.fin,{data:{name:"month",value:c.getMonth()+1,onchange:o,circle:!0,data:$.map(new Array(12),function(e,t){
var n=t+1;
return{value:n,text:n+"\u6708"}})},
from:n.dltMonth})},250),
setTimeout(function(){
	r.publish(t.type.fin,{data:{name:"festival",onchange:f,data:l},from:n.dltFestival})},300),
	this.btnToday=i.find(".mh-btn-today").click(function(e){
		e.preventDefault(),r.publish(t.type.fsv,{data:n.today.getFullYear(),from:n.dltYear}),r.publish(t.type.fsv,{data:n.today.getMonth()+1,from:n.dltMonth}),r.publish(t.type.ftc,{data:{},from:n.dltMonth}),n.panel.find("li.mh-today").click()})}})})();
(function(){var e={getAstroByDate:function(e,t){var n="\u9b54\u7faf\u6c34\u74f6\u53cc\u9c7c\u7261\u7f8a\u91d1\u725b\u53cc\u5b50\u5de8\u87f9\u72ee\u5b50\u5904\u5973\u5929\u79e4\u5929\u874e\u5c04\u624b\u9b54\u7faf",r=[20,19,21,21,21,22,23,23,23,23,22,22];return n.substr(e*2-(t<r[e-1]?2:0),2)+"\u5ea7"}},t=window.OB.RiLi.Huochepiao;$.widget("rili.dayDetail",{options:{},_create:function(){var e=this,t=$(this.element),n=this.options;this.tmpl=[],this.tmpl.push('<div class="mh-dates-bar">'),this.tmpl.push('<span class="mh-date">{year}-{padmonth}-{paddate}</span>'),this.tmpl.push('<span class="mh-weekday">{week}</span>'),this.tmpl.push("</div>"),this.tmpl.push('<div class="mh-date-show-panel">'),this.tmpl.push("{date}"),this.tmpl.push("</div>"),this.tmpl.push('<div class="mh-desc">'),this.tmpl.push('<div class="mh-lunar">\u519c\u5386{lmonth}\u6708{ldate}</div>'),this.tmpl.push('<div class="mh-lunar-ganzhi">'),this.tmpl.push("{gzyear}\u5e74{gzmonth}\u6708{gzdate}\u65e5"),this.tmpl.push("</div>"),this.tmpl.push('<div class="mh-other-info">'),this.tmpl.push('<span class="mh-animal-year">[<em class="mh-animal">{animal}\u5e74</em>]</span>'),this.tmpl.push('<span class="mh-astro">{astro}</span>'),this.tmpl.push("</div>"),this.tmpl.push('<div class="mh-lunar-term">'),this.tmpl.push("{festival}"),this.tmpl.push("</div>"),this.tmpl.push("</div>"),this.tmpl=this.tmpl.join("")},init:function(n,r){var i=this,s=$(this.element),o=this.options,u=n.getFullYear(),a=n.getMonth()+1,f=n.getDate(),l=new Date,c=r.festival();s.html($.format(this.tmpl,{year:u,padmonth:("0"+a).slice(-2),paddate:("0"+f).slice(-2),date:f,week:"\u661f\u671f"+r.cnDay,animal:r.animal,animal_index:jQuery.inArray(r.animal,r.db.chineseZodiac),istoday:l.getDate()==f&&l.getMonth()==n.getMonth()&&l.getFullYear()==u?'<div class="today_icon"></div>':"",lmonth:r.lMonth,ldate:r.lDate,nofestival:c.length||r.term?"":" nofestival",festival:c.length&&$.trim($.format("{desc} ",c))||r.term||"",gzyear:r.gzYear,gzmonth:r.gzMonth,gzdate:r.gzDate,astro:e.getAstroByDate(("0"+a).slice(-2),f)})),window.OB.RiLi.action!="goupiao"?(this.loadLuckyData(u,a,f),$(".mh-almanac-extra").show(),$(".mh-linktail").show()):($(".mh-linktail-goupiao").show(),$(".mh-phone-net .mh-gongli").html(t.getHuochepiaoDayGongli(u,a,f)),$(".mh-proxy .mh-gongli").html(t.getHuochepiaoDayGongliProxy(u,a,f)),$(".mh-phone-net .mh-nongli").html(t.getHuochepiaoDayNongli(u,a,f)),$(".mh-proxy .mh-nongli").html(t.getHuochepiaoDayNongliProxy(u,a,f)),$(".mh-almanac").addClass("mh-almanac-goupiao"),$(".mh-ticket-info").show())},loadLuckyData:function(e,t,n){var r=this,i=$(this.element),s=this.options,o="d"+("0"+t).slice(-2)+("0"+n).slice(-2),u=window.OB.RiLi.HuangLi;u&&u["y"+e]?this.fillLuckyData(u["y"+e][o]):e>2007&&e<2021?(clearTimeout(window.OB.RiLi.getHandle),window.OB.RiLi.getHandle=setTimeout(function(){$.getScript(window.OB.RiLi.hlUrl[e],function(){r.fillLuckyData(window.OB.RiLi.HuangLi["y"+e][o])})},100)):this.fillLuckyData({y:"",j:""})},fillLuckyData:function(e){function t(e){var t=[],t=[],n;return e.sort(function(e,t){return e.length-t.length}),$.each(e,function(n,r){var i="<li>"+r+"</li>",s="<li class='cl'>"+r+"</li>";r.length>3?t.push(s):n%2==1?t.push(i):n==e.length-1?t.push(s):e[n+1].length>3?t.push(s):t.push(i);if(t.length>8)return!1}),t.slice(0,8).join("")}var n=this,r=$(this.element),i=this.options,s=e.y.replace(/^\.|\.$/g,"").split("."),o=e.j.replace(/^\.|\.$/g,"").split(".");$(".mh-suited .mh-st-items").html(t(s)).attr("title",s.join(" ")),$(".mh-tapu .mh-st-items").html(t(o)).attr("title",o.join(" "))}})})();(function(){var e=window.OB.RiLi.mediator,t=window.OB.RiLi.msg_config,n=$(".mh-calendar");e.subscribe(t.type.fsv,function(e){e.from.fakeSelect("setValue",e.data)}),e.subscribe(t.type.ftc,function(e){e.from.fakeSelect("triggerChange")}),e.subscribe(t.type.fhv,function(e){t.returnValue=e.from.fakeSelect("hasValue",e.data)}),e.subscribe(t.type.fgv,function(e){t.returnValue=e.from.fakeSelect("getValue")}),e.subscribe(t.type.fin,function(e){e.from.fakeSelect(e.data)}),e.subscribe(t.type.hin,function(e){n.speCalendar()}),e.subscribe(t.type.hgt,function(e){t.returnValue=n.speCalendar("getTpl",e.data)})})();(function(){var e=window.OB.RiLi.msg_config,t=window.OB.RiLi.mediator,n=function(){var e={},t=$("#mh-rili-params").val()||"";if(t){var n=t.replace(/^\?/,"").split("&"),r;for(var i=0;i<n.length;++i)r=n[i].split("="),e[r[0]]=r[1]}return e};window.OB.RiLi.Dispatcher={dispatch:function(){var r=n();switch(r.action){case"query":t.publish(e.type.actionquery,r);break;case"goupiao":t.publish(e.type.actiongoupiao,r);break;case"festival":t.publish(e.type.actionfestival,r);break;default:t.publish(e.type.actiondefault,r)}}}})();