...
namespace communal\modules\gii\generators\model;
...
{
    public $db = 'db';
    public $ns = 'communal\models\ve_company';
    public $tableName;
    public $modelClass;
    public $baseClass = 'communal\models\VeCompany';
    ...
    {
        if (!$this->getDbConnection() instanceof Connection) {
            $this->addError('db', 'The "db" application component must be a DB connection instance.');
        }elseif (!Yii::$app->has($this->db) && $this->db == 'db') {
             $this->addError('db', 'There is no application component named "db".' . $this->db);
        }
    }
    ...
    protected function getDbConnection()
    {
        ...
        return \communal\helpers\ConnectionHelper::get($this->db);
    }
